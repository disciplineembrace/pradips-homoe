    ...
    <header className="bg-[#173B2D] text-stone-100 shadow-lg sticky top-0 z-50 border-b-2 border-[#C8A24A]/40">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16 gap-4">
          <Link href="/" className="flex-shrink-0 flex items-center gap-2"><img src="/logo-v2-92.png" alt="Pradip's Homoeo" width="36" height="36" className="h-9 w-9 rounded-full object-cover" />

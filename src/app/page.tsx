  ...
  return (
    <div className="min-h-screen flex flex-col bg-stone-50">
      ...
      <main className="flex-1">
        {/* Hero section */}
        <section className="relative bg-gradient-to-br from-emerald-950 via-stone-900 to-amber-950 text-stone-100 py-20 px-4">
          <div className="max-w-5xl mx-auto text-center">
            <h1 className="font-serif italic text-4xl md:text-6xl text-amber-200 mb-4">
              Pradip&apos;s Homoe
            </h1>
            <p className="text-lg md:text-xl text-stone-300 mb-2">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <Link href="/login" className="bg-amber-700 hover:bg-amber-600 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
                Login to Access Library →
              </Link>
              <Link href="/about" className="bg-stone-700 hover:bg-stone-600 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
                Learn More
              </Link>
            </div>
          </div>
        ...
        <section className="py-12 px-4 bg-white">
          <div className="max-w-5xl mx-auto">
            <h2 className="font-serif text-2xl text-emerald-900 text-center mb-8">Library Collection</h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                <div key={i} className="bg-stone-50 border border-stone-200 rounded-lg p-4 text-center">
                  <div className="text-3xl font-bold text-emerald-800 font-serif">{s.num}</div>
                  <div className="text-sm font-semibold text-stone-700 mt-1">{s.label}</div>
        ...
        <section className="py-12 px-4 bg-stone-100">
          <div className="max-w-5xl mx-auto">
            <h2 className="font-serif text-2xl text-emerald-900 text-center mb-8">Features</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={i} className="bg-white rounded-lg shadow p-6">
                  ...
                  <h3 className="font-serif text-lg text-emerald-900 mb-2">{f.title}</h3>
        ...
        {/* CTA section */}
        <section className="py-16 px-4 bg-emerald-950 text-stone-100">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Link href="/login" className="inline-block bg-amber-700 hover:bg-amber-600 text-white font-semibold px-8 py-3 rounded-lg transition-colors">
              Login Now →
            </Link>
          </div>
        </section>

      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-stone max-w-none space-y-6">
          <section className="bg-white rounded-lg shadow p-6">
            <h2 className="font-serif text-2xl text-emerald-800 mb-3">Our Mission</h2>
          ...
          <section className="bg-white rounded-lg shadow p-6">
            <h2 className="font-serif text-2xl text-emerald-800 mb-3">Collection</h2>
            <ul className="space-y-2 text-stone-700">
              <li><b className="text-emerald-900">Materia Medica</b> — 3,471 remedies from 9 authors: Boericke, Phatak, Murphy, Kent, Allen, Sankaran, Farrington, Boeger, and Mathur.</li>
              <li><b className="text-emerald-900">Repertory</b> — 79,706 rubrics spanning Kent (62,696), Phatak (10,840), and Murphy (6,169).</li>
              <li><b className="text-emerald-900">Therapeutics</b> — 408 disease categories with remedy formulas and potencies, sourced from the Encyclopedia of Homoeopathic Formulas by Dr. Saif-ud-Din Saif.</li>
              <li><b className="text-emerald-900">Predictive Homeopathy</b> — Theory of Suppression and Theory of Acutes by Dr. Prafull Vijayakar, 23 chapters of full text.</li>
              <li><b className="text-emerald-900">Synthesis Repertory</b> — Cross-referenced rubric data for advanced repertorization.</li>
            </ul>
          </section>

          <section className="bg-white rounded-lg shadow p-6">
            <h2 className="font-serif text-2xl text-emerald-800 mb-3">Security &amp; Privacy</h2>
          ...
          <section className="bg-white rounded-lg shadow p-6">
            <h2 className="font-serif text-2xl text-emerald-800 mb-3">Technology</h2>
            <p className="text-stone-700 leading-relaxed">
          ...
          <section className="bg-amber-50 border border-amber-200 rounded-lg p-6">
            <h2 className="font-serif text-2xl text-amber-800 mb-3">Disclaimer</h2>

          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-stone-300 rounded-lg text-sm focus:outline-none focus:border-[#124C3B]"
              />
            </div>
          ...
          {showPreview && (
            <div className="mt-5 p-4 border border-stone-200 rounded-lg bg-stone-50">
              ...
              <div className="text-center py-4 bg-white border border-stone-200 rounded">
                ...
                {profile.clinicName && <div className="font-serif text-lg text-[#124C3B]">{profile.clinicName}</div>}
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className={`px-5 py-2 text-sm font-semibold rounded-lg transition-colors ${
                saved ? 'bg-green-600 text-white' : 'bg-[#124C3B] text-white hover:bg-[#0B392D]'
              }`}
            >

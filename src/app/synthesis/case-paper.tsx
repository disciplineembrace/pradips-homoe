...
///   Primary dark green #124C3B, Gold #C79A32, Page bg #F8F6EF,
///   Card #FFFFFF, Border #DEDACF, Text #243A32 / #748078,
///   Delete #C83B3B, Success tint #EAF4EF
///
      ...
      >
        ...
        >
          ...
          {rubrics.length > 0 && (
            ...
            >
              <Icons.Trash size={12} className="text-[#C83B3B]" />
              Clear All
            </button>
          )}
        </div>
                  ...
                  >
                    ...
                    <div className="flex items-start gap-2.5">
                      ...
                      <button
                        ...
                        title="Remove rubric"
                      >
                        <Icons.Trash size={16} className="text-[#C83B3B]" />
                      </button>
                    </div>
                    ...
                    >
                      <Icons.Eye size={14} className="text-[#124C3B]" />
                      View Remedies
                    </button>
                  </div>
                );
      ...
      {rubrics.length > 0 && (
        <div className="space-y-2">
          ...
          >
            {savingCase ? (
              <>
                <span className="inline-block w-3.5 h-3.5 border-2 border-[#124C3B]/30 border-t-[#124C3B] rounded-full animate-spin" />

...
///   Primary dark green : #0F4A38
///   Dark green hover   : #0B3A2C
///   Gold accent        : #C79A32
...
export function PageTitle({
  ...
  return (
    <div className={compact ? 'mb-3' : 'mb-4'}>
      <h1
        className="font-serif font-bold uppercase tracking-wide text-[#0F4A38]"
  ...
  return (
    ...
    >
      <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
        ...
        <circle cx="100" cy="100" r="92" fill="none" stroke="#DED8C9" strokeWidth="1" strokeDasharray="2 3" opacity="0.6" />
        ...
        <g transform="translate(155, 110)">
          ...
          {/* Cap */}
          <rect x="-6" y="-19" width="12" height="5" rx="1" fill="#0F4A38" />
          {/* Highlight */}
          <rect x="-9" y="0" width="2" height="28" rx="1" fill="#F4D58A" opacity="0.6" />
          {/* Label */}
          <rect x="-9" y="8" width="18" height="14" rx="1" fill="#F8F6EF" opacity="0.9" />
          <line x1="-6" y1="13" x2="6" y2="13" stroke="#0F4A38" strokeWidth="0.8" />
          <line x1="-6" y1="16" x2="3" y2="16" stroke="#0F4A38" strokeWidth="0.6" />
        </g>
    ...
    >
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full overflow-hidden">
        <div className="px-5 py-4 border-b border-stone-200 flex items-center gap-3">
          ...
          >
            <Icons.Trash size={18} className="text-[#C62828]" />
          </div>
